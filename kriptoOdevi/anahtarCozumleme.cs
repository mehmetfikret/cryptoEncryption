...
{
    public partial class anahtarCozumleme : Form
    {
        string[] alfabe = { "A", "B", "C", "Ç", "D", "E", "F", "G", "Ğ", "H", "I", "İ", "J", "K", "L", "M", "N", "O", "Ö", "P", "R", "S", "Ş", "T", "U", "Ü", "V", "Y", "Z" };
        public anahtarCozumleme()
        {
            InitializeComponent();
        }

        private void anahtarCozumleme_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int anahtar = anahtarSifreleme.anahtar;
